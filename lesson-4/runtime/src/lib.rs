...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		CarProof: pallet_template::{Pallet, Call, Storage, Event<T>},
	}
);
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			list_benchmark!(list, extra, pallet_template, CarProof);
		...
		fn dispatch_benchmark(
			...
			add_benchmark!(params, batches, pallet_template, CarProof);
	...
	impl pallet_contracts_rpc_runtime_api::ContractsApi<Block, AccountId, Balance, BlockNumber, Hash> for Runtime {
		...
		fn instantiate(origin: AccountId,
			endowment: Balance,
			gas_limit: u64,
